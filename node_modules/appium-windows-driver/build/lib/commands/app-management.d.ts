 ...
 * @this {WindowsDriver}
 */
export function windowsLaunchApp(this: import("../driver").WindowsDriver): Promise<any>;
/**
 ...
 */
export function windowsCloseApp(this: import("../driver").WindowsDriver): Promise<any>;
