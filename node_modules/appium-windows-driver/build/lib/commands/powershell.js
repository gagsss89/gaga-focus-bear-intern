 ...
 */
async function execPowerShell(opts) {
    ...
    try {
        ...
        if (shouldRunScript) {
            ...
            tmpScriptPath = path_1.default.resolve(tmpRoot, 'appium_script.ps1');
        ...
        if (command) {
            ...
            const { stdout } = await (0, teen_process_1.exec)(POWER_SHELL, ['-command', 'Get-ExecutionPolicy -Scope CurrentUser']);
            userExecutionPolicy = lodash_1.default.trim(stdout);
            if ([EXECUTION_POLICY.RESTRICTED, EXECUTION_POLICY.UNDEFINED].includes(userExecutionPolicy)) {
                ...
                await (0, teen_process_1.exec)(POWER_SHELL, [
        ...
        try {
            const { stdout } = await (0, teen_process_1.exec)(POWER_SHELL, psArgs);
            return stdout;
        }
        catch (e) {
