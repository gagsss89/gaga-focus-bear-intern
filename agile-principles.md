...
**Personal Example - Using Agile During My QA Bootcamp Project**

During my QA bootcamp, I worked on a group project with my fellow students where we had to build and test an automation framework from scratch. At first, we tried to plan everything in detail, but as we started working, we realized things changed constantly, some tools didn’t work as expected, and some tests took longer to automate than we thought.

To stay on track, we naturally started using Agile principles:

- We had daily catch-ups (informal standups) where everyone shared progress and blockers
- We broke the project into smaller user stories and focused on one task at a time
- We supported each other when someone had trouble with a tool or concept
- At the end of each week, we reviewed what we completed and adjusted our plan for the next sprint
